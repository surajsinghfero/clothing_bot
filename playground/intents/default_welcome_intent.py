...
def welcome_intent(req):
    ...
    data = basicCard(fulfillment_text, title, formattedText, subtitle, card_image, "CROPPED", image_text, link_title,
                     link_url, outputContexts, suggestions, response=True)
